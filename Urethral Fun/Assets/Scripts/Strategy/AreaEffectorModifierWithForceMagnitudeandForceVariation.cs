...
{
    class AreaEffectorModifierWithForceMagnitudeandForceVariation : IAreaEffectorModifier
    {
        public void AreaEffectorChangerStrategy(GameObject slider, GameObject current)
        {
